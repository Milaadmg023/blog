export default function Footer() {
  return (
    <>
      <div className="flex items-center gap-4 justify-center p-2">
        <div className="social-button">
          <button className="relative w-12 h-12 rounded-full group">
            ...
            <div className="icon relative w-full h-full flex items-center justify-center border-2 border-violet-400 rounded-full">
              <svg
        ...
        <div className="social-button">
          <button className="relative w-12 h-12 rounded-full group">
            ...
            <div className="icon relative w-full h-full flex items-center justify-center border-2 border-black rounded-full">
              <svg
                height={24}
                width={24}
                viewBox="0 0 24 24"
        ...
        <div className="social-button">
          <button className="relative w-12 h-12 rounded-full group">
            ...
            <div className="icon relative w-full h-full flex items-center justify-center border-2 border-blue-500 rounded-full">
              <svg
                height={24}
                width={24}
                viewBox="0 0 24 24"
        ...
        <div className="social-button">
          <button className="relative w-12 h-12 rounded-full group">
            ...
            <div className="icon relative w-full h-full flex items-center justify-center border-2 border-red-400 rounded-full">
              <svg
                height={32}
                width={32}
                viewBox="0 0 32 32"
      ...
      <p className="text-center">با ما در ارتباط باشید 🤞</p>
    </>
  );
}
